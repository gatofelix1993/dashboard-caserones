...
const S = {
  ...
  main:    { flex:1, overflowY:'auto', padding:'clamp(12px,2vw,24px) clamp(12px,3vw,28px)', display:'flex', flexDirection:'column', gap:20 },
  ...
  kpiRow:  { display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(130px,1fr))', gap:12 },
